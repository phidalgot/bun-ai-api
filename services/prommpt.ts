...
1.- RGI 1-2: Encuentra partida (4 dígitos) y subpartida (6 dígitos).
...
- Código final: Propón el código NCM de 6 dígitos con confianza (alta/media/baja) y justificación breve. Incluye partida alternativa si aplica RGI 3c.
